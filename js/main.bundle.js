...
/* harmony export */   "checkValidName": () => (/* binding */ checkValidName),
...
let db = new dexie__WEBPACK_IMPORTED_MODULE_0__["default"]("PlayersDatabase");
db.version(1).stores({
  players: "++id, name",
});
...
const checkValidName = () => {
  ...
  input.removeEventListener("input", removeErrorClass);

  if (name.length < 3) {
    let span = document.createElement("span");
    span.classList.add("span-error");
    span.innerText = "El nombre debe contener al menos 3 caracteres";
    input.after(span);
    input.value = "";
...
(0,_registerServiceWorker__WEBPACK_IMPORTED_MODULE_3__["default"])();

if (indexedDB) {
  //   createPlayer({ name: "Felix", score: 236 });
  //   getPlayer("Felix");
  let button = document.getElementById("addPlayer");
  button.addEventListener("click", () => {
    console.log("CLICK");
    (0,_gameLogic_js__WEBPACK_IMPORTED_MODULE_2__.checkValidName)();
  });
}
